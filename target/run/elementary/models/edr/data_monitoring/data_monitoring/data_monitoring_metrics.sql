-- back compat for old kwarg name
  ...
  begin;
    ...
    merge into NBA.dbt_parker_elementary.data_monitoring_metrics as DBT_INTERNAL_DEST
        using NBA.dbt_parker_elementary.data_monitoring_metrics__dbt_tmp as DBT_INTERNAL_SOURCE
        on (
