-- back compat for old kwarg name
  ...
  begin;
    ...
    merge into NBA.dbt_parker_elementary.schema_columns_snapshot as DBT_INTERNAL_DEST
        using NBA.dbt_parker_elementary.schema_columns_snapshot__dbt_tmp as DBT_INTERNAL_SOURCE
        on (
