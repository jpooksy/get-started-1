-- back compat for old kwarg name
  ...
  begin;
    ...
    merge into NBA.dbt_parker_elementary.dbt_run_results as DBT_INTERNAL_DEST
        using NBA.dbt_parker_elementary.dbt_run_results__dbt_tmp as DBT_INTERNAL_SOURCE
        on (
