-- back compat for old kwarg name
  ...
  begin;
    ...
    merge into NBA.dbt_parker_elementary.test_result_rows as DBT_INTERNAL_DEST
        using NBA.dbt_parker_elementary.test_result_rows__dbt_tmp as DBT_INTERNAL_SOURCE
        on (
